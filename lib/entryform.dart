...
class EntryFormState extends State<EntryForm> {
  ...
  Widget build(BuildContext context) {
    ...
    if (contact != null) {
      ...
      deskripsiController.text = contact.desk;
      obatController.text = contact.obat;
    }
    //rubah
    return Scaffold(
        appBar: AppBar(
          title: contact == null ? Text('Tambah Data Penyakit') : Text('Rubah Data Penyakit'),
                    ...
                    Expanded(
                      child: RaisedButton(
                        ...
                        onPressed: () {
                          if (contact == null) {
                            // tambah data
                            contact = Contact(nameController.text, deskripsiController.text, obatController.text);
                          } else {
                            // ubah data
                            contact.name = nameController.text;
                            contact.desk = deskripsiController.text;
                            contact.obat = obatController.text;
                          }
